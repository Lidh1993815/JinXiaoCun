...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter{
    ...
    private View mNetworkErrorView; //没有网络的图标
    private View mTheEndView; //加载全部的图标
    private SimpleViewSwitcher mProgressView;
    private TextView mLoadingText;//正在加载
    private TextView mNoMoreText;//没有更多时显示的文字
    private TextView mNoNetWorkText;//没有网络时显示的文字
