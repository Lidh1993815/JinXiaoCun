...
import com.qianmo.jinxiaocun.fu.adapter.BaseAdapter;
import com.qianmo.jinxiaocun.fu.adapter.TabViewPagerAdapter;
...
public class TabContainerView extends RelativeLayout {
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        divideLineHeight = typedArray.getDimensionPixelSize(R.styleable.TabContainerViewStyle_divideLineHeight,DPUtils.dip2px(context,1));
