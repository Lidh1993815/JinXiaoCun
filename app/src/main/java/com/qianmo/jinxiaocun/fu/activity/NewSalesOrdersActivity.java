 ...
 * 新建销售单界面
 */
public class NewSalesOrdersActivity extends BaseActivity implements View.OnClickListener {
    /**
     * 已经获取到多少条数据了
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBar = new MyToolBar(this, R.mipmap.zoujiant, "新建销售单", -1);
        setContentView(requestView(R.layout.activity_new_sales_orders));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            //扫描
            case R.id.scanning:
                ToastUtils.MyToast(NewSalesOrdersActivity.this,"扫描");
                break;
            //添加
            case R.id.add_order:
