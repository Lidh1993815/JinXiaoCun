 ...
 * 新建销售退货单界面
 */
public class NewSalesReturnActivity extends BaseActivity implements View.OnClickListener {
    /**
     * 已经获取到多少条数据了
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBar = new MyToolBar(this, R.mipmap.zoujiant, "新建销售退货单", -1);
        setContentView(requestView(R.layout.activity_new_sales_return));
