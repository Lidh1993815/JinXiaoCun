 ...
 * version: 1.0
 */
public class BirthdayNotifyFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    /**
     * 服务器端一共多少条数据
     */
    ...
    public static BirthdayNotifyFragment newInstance(int status) {
        BirthdayNotifyFragment fragment = new BirthdayNotifyFragment();
    ...
    private class TaskAdapter extends ListBaseAdapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.fu_birthday_recycle_item;
        }
