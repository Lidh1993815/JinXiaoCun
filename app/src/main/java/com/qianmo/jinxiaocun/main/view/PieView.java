...
class PieView extends View implements Determinate {
    ...
    private void init(){
        ...
        mWhitePaint.setStrokeWidth(DPUtils.dip2px(getContext(),0.1f));
        mWhitePaint.setColor(Color.WHITE);

        mGreyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mGreyPaint.setStyle(Paint.Style.STROKE);
        mGreyPaint.setStrokeWidth(DPUtils.dip2px(getContext(),2));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int dimension = DPUtils.dip2px(getContext(),2);
