...
package com.qianmo.jinxiaocun.main.view;
...
class BarView extends View implements Determinate {
    ...
    private void init() {
        ...
        mOuterPaint.setStrokeWidth(DPUtils.dip2px(getContext(),2));
        ...
        mBoundGap = DPUtils.dip2px(getContext(),5);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = DPUtils.dip2px(getContext(),2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthDimension = DPUtils.dip2px(getContext(),100);
        int heightDimension = DPUtils.dip2px(getContext(),20);
